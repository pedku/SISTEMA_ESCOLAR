...
parent_bp = Blueprint('parent', __name__, url_prefix='/')
...
@parent_bp.route('/parent/grades/<int:student_id>')
...
@parent_bp.route('/parent/attendance/<int:student_id>')
...
@parent_bp.route('/parent/report-cards/<int:student_id>')
